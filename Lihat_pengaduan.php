                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($lihatpengaduan as $pengaduan) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php
                                                            if ($pengaduan['status']==0){echo"belum divalidasi";
                                                            ...
                                                            <td>
                                                                <a onclick="return confirm('Aapakah Anda yakin menghapus data ini?')"
                                                                class="btn btn-danger"
                                                                href="masyarakat_model.php?hapus=<?=$pengaduan['foto']; ?>">Hapus</a>
                                                            </td>
                                                        </tr>
                                                    <?php $no++;
                                                    } ?>
